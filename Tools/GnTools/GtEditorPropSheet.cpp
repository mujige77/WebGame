...
void GtEditorPropSheet::SetObject(GtObject* pObject, GtSequenceInfo* pEditSequence)
{
	for( int i = 0 ; i < GetPageCount() ; i++ )
	{
		GtPropertyPage* page = (GtPropertyPage*)GetPage( i );
		page->SetSequenceInfo( pEditSequence );
