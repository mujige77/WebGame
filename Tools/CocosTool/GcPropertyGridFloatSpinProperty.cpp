...
GcPropertyGridFloatSpinProperty::GcPropertyGridFloatSpinProperty(const CString& strGroupName, DWORD_PTR dwData,
	BOOL bIsValueList) : GcPropertyGridProperty(strGroupName, dwData, bIsValueList),	mAccumulateDelta(0.0f)
{

}

GcPropertyGridFloatSpinProperty::GcPropertyGridFloatSpinProperty(const CString& strName, const COleVariant& varValue,
	LPCTSTR lpszDescr, DWORD_PTR dwData, LPCTSTR lpszEditMask, LPCTSTR lpszEditTemplate, LPCTSTR lpszValidChars) :
	GcPropertyGridProperty(strName, varValue, lpszDescr, dwData, lpszEditMask, lpszEditTemplate, lpszValidChars),
	mFloatVlaue((float)dwData)
{

}
GcPropertyGridFloatSpinProperty::~GcPropertyGridFloatSpinProperty(void)
{
}

void GcPropertyGridFloatSpinProperty::EnableFloatSpinControl(bool bEnable, int iMin, int iMax)
{
...
CSpinButtonCtrl* GcPropertyGridFloatSpinProperty::CreateSpinControl(CRect rectSpin)
{
	ASSERT_VALID(this);
...
BOOL GcPropertyGridFloatSpinProperty::OnUpdateValue()
{
	...
	GcFloatSpinButtonCtrl*spin = (GcFloatSpinButtonCtrl*)m_pWndSpin;
...
BOOL GcPropertyGridFloatSpinProperty::OnEndEdit()
{
	float* val;
	switch (m_varValue.vt)
	{
